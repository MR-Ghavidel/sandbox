...
<div
    ...
    class="relative"
>
    <button type="button" data-month-picker-toggle aria-haspopup="dialog" aria-expanded="false" title="انتخاب ماه" aria-label="انتخاب ماه از تقویم" class="flex items-center rounded-lg border border-slate-200 bg-white p-2 text-slate-600 hover:bg-slate-50 hover:text-sky-700 aria-expanded:border-sky-300 aria-expanded:bg-sky-50 aria-expanded:text-sky-700">
    ...
    <div
        ...
        class="pointer-events-none invisible absolute end-0 top-full z-30 mt-2 w-72 origin-top-left scale-95 rounded-2xl border border-slate-200 bg-white p-3 opacity-0 shadow-xl ring-1 ring-slate-900/5 transition duration-150 ease-out data-[open]:pointer-events-auto data-[open]:visible data-[open]:scale-100 data-[open]:opacity-100"
    >
        <div class="mb-3 flex items-center justify-between">
            <button type="button" data-year-step="-1" class="rounded-lg p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-800" aria-label="سال قبل">
            ...
            <button type="button" data-year-step="1" class="rounded-lg p-1.5 text-slate-500 hover:bg-slate-100 hover:text-slate-800" aria-label="سال بعد">
        ...
        <div class="mt-3 flex items-center justify-between border-t border-slate-100 pt-2.5 text-xs">
            <span class="flex items-center gap-1.5 text-slate-500"><span class="size-1.5 rounded-full bg-emerald-500"></span> دارای داده</span>
            <a href="{{ route('payroll.index') }}" class="rounded-md px-2 py-1 font-medium text-sky-700 hover:bg-sky-50">ماه جاری</a>
        </div>
    </div>
</div>
