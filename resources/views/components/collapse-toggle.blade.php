...
<button type="button" data-collapse-toggle aria-expanded="true" {{ $attributes->merge(['class' => 'rounded-md p-1 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200']) }} aria-label="جمع / باز کردن">
